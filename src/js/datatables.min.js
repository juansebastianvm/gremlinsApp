 ...
 *
 * Included libraries:
 *  jQuery 3.6.0, DataTables 1.13.3
 */
  ...
  var Ie = [],
    ...
    He =
      ...
      (C.defaults = {
        ...
        oLanguage: {
          oAria: {
            sSortAscending: ": activar ordenamiento de columna ascedente",
            sSortDescending: ": activar ordenamiento de columna descendente",
          },
          oPaginate: {
            sFirst: "Primera",
            sLast: "Ultima",
      ...
      (C.ext = p =
        {
          buttons: {},
          classes: {},
          builder: "bs5/jq-3.6.0/dt-1.13.3",
          errMode: "alert",
          feature: [],
          search: [],
